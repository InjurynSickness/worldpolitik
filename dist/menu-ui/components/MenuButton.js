...
export const MenuButton = React.forwardRef(({ className, children, onClick, disabled, ...props }, ref) => {
    return (_jsx("button", { ref: ref, onClick: onClick, disabled: disabled, className: `
          w-full px-4 py-2 
